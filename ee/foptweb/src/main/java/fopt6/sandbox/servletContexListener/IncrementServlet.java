...
@WebServlet(urlPatterns = "/sandbox/contextlistener-servlet/reset", loadOnStartup = 0)
public class IncrementServlet extends HttpServlet {
    ...
    public void init() {
        ...
        System.out.println("init() accessing counter_2 in servlet context (via listener) in sandbox/contextlistener-servlet w/ " + counter);
    }
