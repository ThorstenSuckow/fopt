...
public class Model
{
    ...
    /**
     * Returns true if the vocabulary was loaded from the file,
     * otherwise false.
     * @return
     */
    public boolean initVocab() {
    ...
    private void fillVocab() throws Exception {
        BufferedReader in = new BufferedReader(
            new FileReader(
                getClass().getClassLoader().getResource("fopt4/uebung1_2/german_english.txt").getFile()
            )
        );
