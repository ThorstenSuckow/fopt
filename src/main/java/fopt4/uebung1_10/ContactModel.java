...
public class ContactModel
{
    ...
    private void createSampleData() {
        ...
        createContact("Herbert", "Grönemeyer", "herbert@eisbaer.de");
        createContact("Georg Friedrich", "Händel", "haendel@haendel.uk");
        ...
        createContact("Anna", "Müller", "anna@haeufiger-name.de");
        createContact("David", "Müller", "david@haeufiger-name.de");
        createContact("Thomas", "Müller", "thomas@haeufiger-name.de");
