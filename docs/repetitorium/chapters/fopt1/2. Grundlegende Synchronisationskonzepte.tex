...
} gekennzeichnet wird, un ein Thread $t_1$ auf diese \code{synchronized} Methode zugreift, dann wird das Objekt für andere Threads $t_2..t_n$ gesperrt, die gleichzeitig auf andere \code{synchronized} Methoden zugreifen wollen.\\
