...
\begin{itemize}
    ...
    \item ermöglicht das Setzen \code{lock()} / Entfernen \code{unlock()} von Sperren im Code auch über Methoden hinweg (\code{synchronized} sperrt eine Methode ), aber nur \textit{von ein und demselben} Thread\footnote{Lehrbuch: das kann als Vor-/Nachteil gesehen werden - \cite[149]{Oec22}}.
