...
Sollen die Ergebnisse der Aufrufe in der UI dargetsellt werden, sollte die Aktualisierung der View mit den Daten Über \code{Platform.runLater()} erfolgen.
