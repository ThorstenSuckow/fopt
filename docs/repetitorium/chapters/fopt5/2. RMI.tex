...
\begin{tcolorbox}
    ...
    Werden gleichzeitig mehrere Methoden ein und desselben RMI-Objektes von unterschiedlichen Clients aufgerufen, sollten die Methoden ggf. \code{synchronized} sein.
\end{tcolorbox}
...
\section{Referenzübergabe für Parameter und Rückgabewerte}\label{sec:refrmi}
